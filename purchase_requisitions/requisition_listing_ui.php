  ...
  <main class="main" id="top">
    <div class="container" data-layout="container">
      ...
      <div class="content">
        ...
        <h5 class="mb-0">Requisition Listing</h5>
        <!-- ===============================================-->
        <!--    COMPONENT:: Add it -->
        <!-- -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_ -->
        <div class="card mt-1">
        ...
        <script>
          let updateTable = (data) => {
            ...
            elem.setAttribute("redirect", getBaseUrl() + "/products/edit-requisition-ui.php");
          ...
          window.addEventListener('DOMContentLoaded', (event) => {
            ...
            fetch('../includes/listings/list_requisition.php')
