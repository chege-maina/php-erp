          ...
          <table class="table table-striped" id="data_table">
            ...
            <tbody id="table_body">
              <tr id="row1">
                ...
                <td>
                  <input type="button" id="edit_button1" class="btn-falcon-primary" value="Edit" class="edit" onclick="edit_row('1')">
                  <input type="button" id="save_button1" value="Save" class='btn-falcon-success' class="save" onclick="save_row('1')">
                  <input type="button" value="Delete" class='btn-falcon-danger ' onclick="delete_row('1')">
                </td>
              </tr>
              <tr>
                <td><input type="text" class="form-control" id="new_name"></td>
                ...
                <td><input type="text" class="form-control" id="new_phone"></td>
                <td><input type="text" class="form-control" id="new_email"></td>
                <td><input type="button" class='btn-falcon-success' onclick="add_row();" value="Add Row"></td>
              </tr>
            </tbody>
          </table>
        </div>
...
<script>
  ...
  function edit_row(no) {
    ...
    relation.innerHTML = "<input type='text' class='form-control' id='relation_text" + no + "' value='" + relation_data + "'>";
    phone.innerHTML = "<input type='text' class='form-control' id='phone_text" + no + "' value='" + phone_data + "'>";
    email.innerHTML = "<input type='text' class='form-control' id='email_text" + no + "' value='" + email_data + "'>";
  }
  ...
  function add_row() {
    ...
    var row = table.insertRow(table_len).outerHTML = "<tr id='row" + table_len + "'><td id='name_row" + table_len + "'>" + new_name + "</td><td id='relation_row" + table_len + "'>" + new_relation + "</td><td id='phone_row" + table_len + "'>" + new_phone + "</td><td id='email_row" + table_len + "'>" + new_email + "</td><td><input type='button' id='edit_button" + table_len + "' value='Edit' class='btn-falcon-primary' onclick='edit_row(" + table_len + ")'> <input type='button' class='btn-falcon-success' id='save_button" + table_len + "' value='Save' onclick='save_row(" + table_len + ")'> <input type='button' value='Delete' class='btn-falcon-danger' onclick='delete_row(" + table_len + ")'></td></tr>";
