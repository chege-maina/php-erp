...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2021 at 12:51 PM
...
(52, 'Hayden Duran', 'kgs', 'chuma', '9', '500', '18', '/uploads/php.png', 148330, 91000, 91000, 0, 63, 'Jael Joel'),
(53, 'Wyoming Wilkinson', 'lts', 'cement', '21', '400', '67', '/uploads/php.png', 10686, 7800, 7800, 0, 37, 'Jael Joel');
...
INSERT INTO `tbl_quotation_items` (`quote_no`, `product_code`, `product_name`, `unit`, `price`, `qty`, `amount`, `tax`, `status`, `tax_pc`) VALUES
