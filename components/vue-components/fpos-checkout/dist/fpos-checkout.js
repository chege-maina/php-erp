...
// CONCATENATED MODULE: ./src/components/CheckOut.vue?vue&type=template&id=5c0b0b38&shadow
  ...
  watch: {
    shipping: {
      handler: function handler() {
        ...
        sessionStorage.setItem("sendable_table", JSON.stringify(sessionStorage));
      }
    },
    cash_paid: {
      handler: function handler() {
