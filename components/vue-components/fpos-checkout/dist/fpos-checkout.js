...
// CONCATENATED MODULE: ./src/components/CheckOut.vue?vue&type=template&id=d549d2d8&shadow
...
/* harmony default export */ var CheckOutvue_type_script_lang_js_shadow = ({
  ...
  methods: {
    ...
    paymentInputClicked: function paymentInputClicked(elem) {
      var cash_input = document.querySelector("#cash_input");
      var visa_input = document.querySelector("#visa_input");
      var mpesa_input = document.querySelector("#mpesa_input");
