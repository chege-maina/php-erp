...
/* harmony default export */ var CheckOutvue_type_script_lang_js_shadow = ({
  ...
  watch: {
    shipping: {
      handler: function handler() {
        ...
        var sendableTable = sessionStorage.getItem("sendable_table") === null ? {} : JSON.parse(sessionStorage.getItem("sendable_table"));
  ...
  methods: {
    calculateBalance: function calculateBalance() {
      ...
      var sendableTable = JSON.parse(sessionStorage.getItem("sendable_table"));
    ...
    checkoutNow: function checkoutNow() {
      var event = new Event("checkout_now"); // Dispatch the event.
