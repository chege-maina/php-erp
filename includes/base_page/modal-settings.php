    ...
    <div class="modal-content border-0 vh-100 scrollbar">
      ...
      <div class="modal-body px-card" id="themeController">
        ...
        <div class="text-center mt-5"><img class="mb-4" src="../assets/img/illustrations/settings.png" alt="" width="120" />
          ...
          <p class="fs--1">Get Falcon now and create billions and billions beautiful dashboards with hundreds of widgets.</p><a class="btn btn-primary" href="https://themes.getbootstrap.com/product/falcon-admin-dashboard-webapp-template/" target="_blank">Purchase</a>
        </div>
      </div>
    </div>
  </div>
