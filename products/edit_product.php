...
$dsp_price = $_REQUEST['dsp_price'];
$amount_before_tax = $_REQUEST['amount_before_tax'];
$dpp_inc_tax = $_REQUEST['dpp_inc_tax'];
$applicable_tax = $_REQUEST['applicable_tax'];
$profit_margin = $_REQUEST['profit_margin'];
$product_supplier = $_REQUEST['product_supplier'];
$update="update tbl_product set product_name='".$product_name."' ,product_unit='".$product_unit."', product_category='".$product_category."', min_level='".$min_level."', max_level='".$max_level."', reorder='".$reorder."', product_image='".$product_image."', dsp_price='".$dsp_price."',amount_before_tax='".$amount_before_tax."', dpp_inc_tax='".$dpp_inc_tax."', applicable_tax='".$applicable_tax."', profit_margin='".$profit_margin."',product_supplier='".$product_supplier."' where product_code='".$product_code."'";
mysqli_query($conn, $update) or die(mysqli_error());
$status = "Record Updated Successfully. </br></br>
<a href='view-product-ui.php'>View Updated Record</a>";
echo '<p style="color:#FF0000;">'.$status.'</p>';
}else {
?>
        <!-- Content is to start here -->
        <form action="edit_product.php" method="post" name="edit_product" id="edit_product" enctype="multipart/form-data">
          <div class="card">
