  ...
  <main class="main" id="top">
    <div class="container" data-layout="container">
      ...
      <div class="content">
        ...
        <h5 class="mb-0">Receipt Advice Listing</h5>
        <!-- ===============================================-->
        <!--    COMPONENT:: Add it -->
        <!-- -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_ -->
        <div class="card mt-1">
        ...
        <script>
          let updateTable = (data) => {
            ...
            elem.setAttribute("manage_key", "Advice_No");
            elem.setAttribute("manage_key_2", "Supplier");
            elem.setAttribute("redirect", getBaseUrl() + "/Accounts/edit_receiptadvice.php");
          ...
          window.addEventListener('DOMContentLoaded', (event) => {
            ...
            fetch('../includes/listings/list_receiptadvice.php')
