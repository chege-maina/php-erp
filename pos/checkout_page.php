      ...
      <div class="card-body">
        <form>
          ...
          <div class="row gx-0 pl-2 mb-4">
            <div class="col-sm-8 px-3">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-6">
                  <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0">CVV<a class="d-inline-block" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Card verification value"><svg class="svg-inline--fa fa-question-circle fa-w-16 ml-2" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="question-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                      ...
                      </svg><!-- <span class="fa fa-question-circle ml-2"></span> --></a></label>
                  <input class="form-control" type="text" placeholder="123" maxlength="3" pattern="[0-9]{3}">
                </div>
              </div>
            </div>
            <div class="col-4 pl-3 text-center pt-2 d-none d-sm-block">
          ...
          <div class="form-check d-flex align-items-center">
            ...
            <label class="form-check-label mb-0 ml-2" for="paypal"><img src="../assets/img/icons/icon-paypal-full.png" height="20" alt="">
            </label>
          </div>
          <div class="border-dashed-bottom my-5"></div>
          <div class="row">
            <div class="col-md-7 col-xl-12 col-xxl-7 px-md-3 mb-xxl-0 position-relative">
              <div class="d-flex"><img class="mr-3" src="../assets/img/icons/shield.png" alt="" width="60" height="60">
                <div class="flex-1">
                  ...
                  <div class="form-check">
                  ...
                  </div><a class="fs--1 ml-3 pl-2" href="#!">Learn More<svg class="svg-inline--fa fa-caret-right fa-w-6 ml-1" data-fa-transform="down-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" data-fa-i2svg="" style="transform-origin: 0.1875em 0.625em;">
                    ...
                    </svg><!-- <span class="fas fa-caret-right ml-1" data-fa-transform="down-2">    </span> --></a>
                </div>
              </div>
