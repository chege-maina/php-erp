                ...
                <div class="card-body pt-0">
                  <div class="row h-100">
                    <div class="col align-self-end">
                      <div class="fs-4 fw-normal font-sans-serif text-700 lh-1 mb-1">58.4K</div><span class="badge rounded-pill fs--2 bg-200 text-primary"><span class="fas fa-caret-up mr-1"></span>13.6%</span>
                    </div>
                    <div class="col-auto pl-0">
                ...
                <div class="card-body">
                  <div class="row h-100 justify-content-between g-0">
                    <div class="col-5 col-sm-6 col-xxl pr-2">
                      <h6 class="mt-1"><?=$_SESSION['name']?></h6>
                      <div class="fs--2 mt-3">
          ...
          <div class="row g-0">
            <div class="col-lg-6 pr-lg-2 mb-3">
              <div class="card h-lg-100 overflow-hidden">
                    ...
                    <div class="col py-1">
                      <div class="row flex-end-center g-0">
                        ...
                        <div class="col-5 pr-card pl-2">
                          <div class="progress bg-200 mr-2" style="height: 5px;">
                ...
                <div class="card-footer bg-light p-0"><a class="btn btn-sm btn-link d-block w-100 py-2" href="#!">Show all projects<span class="fas fa-chevron-right ml-1 fs--2"></span></a></div>
              </div>
            </div>
                ...
                <div class="card-body d-flex align-items-center">
                  <div class="w-100">
                    ...
                    <div class="progress mb-3 rounded-3" style="height: 10px;">
                      <div class="progress-bar bg-progress-gradient border-right border-white border-2" role="progressbar" style="width: 43.72%" aria-valuenow="43.72" aria-valuemin="0" aria-valuemax="100"></div>
                    ...
                    <tbody>
                      <tr class="border-bottom border-200">
                        ...
                        <td class="align-middle pr-card">
                          <div class="d-flex align-items-center">
                            <div class="progress w-100 mr-2 rounded-3 bg-200" style="height: 5px;">
                      ...
                      <tr class="border-bottom border-200">
                        ...
                        <td class="align-middle text-right fw-semi-bold">$860</td>
                        <td class="align-middle pr-card">
                          <div class="d-flex align-items-center">
                            <div class="progress w-100 mr-2 rounded-3 bg-200" style="height: 5px;">
                      ...
                      <tr class="border-bottom border-200">
                        ...
                        <td class="align-middle pr-card">
                          <div class="d-flex align-items-center">
                            ...
                            <div class="fw-semi-bold ml-2">8%</div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                ...
                <div class="card-body pb-0">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    ...
                    <div class="ml-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="fs--1"><span class="fw-semi-bold">Antony</span><span class="fw-medium text-600 ml-2">Just Now</span></div>
                      <div class="hover-actions right-0 top-50 translate-middle-y"><a class="btn btn-light border-300 btn-sm mr-1 text-600" data-toggle="tooltip" data-placement="top" title="Download" href="assets/img/icons/cloud-download.svg" download="download"><img src="assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                  ...
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    ...
                    <div class="ml-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="fs--1"><span class="fw-semi-bold">Antony</span><span class="fw-medium text-600 ml-2">Yesterday at 1:30 PM</span></div>
                      <div class="hover-actions right-0 top-50 translate-middle-y"><a class="btn btn-light border-300 btn-sm mr-1 text-600" data-toggle="tooltip" data-placement="top" title="Download" href="assets/img/icons/cloud-download.svg" download="download"><img src="assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                        <button class="btn btn-light border-300 btn-sm mr-1 text-600 shadow-none" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><img src="assets/img/icons/edit-alt.svg" alt="" width="15" /></button>
                      </div>
                    </div>
                  ...
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    ...
                    <div class="ml-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="fs--1"><span class="fw-semi-bold">Jane</span><span class="fw-medium text-600 ml-2">27 Sep at 10:30 AM</span></div>
                      <div class="hover-actions right-0 top-50 translate-middle-y"><a class="btn btn-light border-300 btn-sm mr-1 text-600" data-toggle="tooltip" data-placement="top" title="Download" href="assets/img/icons/cloud-download.svg" download="download"><img src="assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                        <button class="btn btn-light border-300 btn-sm mr-1 text-600 shadow-none" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><img src="assets/img/icons/edit-alt.svg" alt="" width="15" /></button>
                      </div>
                    </div>
                  ...
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    ...
                    <div class="ml-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="fs--1"><span class="fw-semi-bold">Rowen</span><span class="fw-medium text-600 ml-2">23 Sep at 6:10 PM</span></div>
                      <div class="hover-actions right-0 top-50 translate-middle-y"><a class="btn btn-light border-300 btn-sm mr-1 text-600" data-toggle="tooltip" data-placement="top" title="Download" href="assets/img/icons/cloud-download.svg" download="download"><img src="assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                        <button class="btn btn-light border-300 btn-sm mr-1 text-600 shadow-none" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><img src="assets/img/icons/edit-alt.svg" alt="" width="15" /></button>
                      </div>
                    </div>
                  ...
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    ...
                    <div class="ml-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="fs--1"><span class="fw-semi-bold">John</span><span class="fw-medium text-600 ml-2">1 Oct at 4:30 PM</span></div>
                      <div class="hover-actions right-0 top-50 translate-middle-y"><a class="btn btn-light border-300 btn-sm mr-1 text-600" data-toggle="tooltip" data-placement="top" title="Download" href="assets/img/icons/cloud-download.svg" download="download"><img src="assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                        <button class="btn btn-light border-300 btn-sm mr-1 text-600 shadow-none" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><img src="assets/img/icons/edit-alt.svg" alt="" width="15" /></button>
                      </div>
                    </div>
          ...
          <div class="row g-0">
            <div class="col-sm-6 col-xxl-3 pr-sm-2 mb-3 mb-xxl-0">
              <div class="card">
                ...
                <div class="card-footer bg-light p-0"><a class="btn btn-sm btn-link d-block w-100 py-2" href="pages/people.html">All active users<span class="fas fa-chevron-right ml-1 fs--2"></span></a></div>
              </div>
            </div>
                ...
                <div class="card-header bg-light py-2">
                  <div class="row flex-between-center">
                    ...
                    <div class="col-auto d-flex"><a class="btn btn-link btn-sm mr-2" href="#!">View Details</a>
                      <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none" type="button" id="dropdown-top-products" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--2"></span></button>
