  ...
  <main class="main" id="top">
    <div class="container" data-layout="container">
      ...
      <div class="content">
        ...
        <h5 class="mb-0">Sales Invoice Listing</h5>
        <!-- ===============================================-->
        <!--    COMPONENT:: Add it -->
        <!-- -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_ -->
        <div class="card mt-1">
        ...
        <script>
          let updateTable = (data) => {
            ...
            elem.setAttribute("manage_key", "Sale_Bill");
            elem.setAttribute("manage_key_2", "Sale_Order_No.");
            elem.setAttribute("redirect", getBaseUrl() + "/sales_invoice/edit_salesinvoice.php");
          ...
          window.addEventListener('DOMContentLoaded', (event) => {
            ...
            fetch('../includes/listings/list_salesinvoice.php')
