    ...
    <div class="container" data-layout="container">
      ...
      <div class="content">
        ...
        <div id="main-body">
          ...
          <h3 class="mb-0 p-2">Transfer Approval</h3>
          <div class="card mb-1">
            ...
            <div class="card-body position-relative">
              ...
              <div class="row">
                ...
                <div class="col">
                  <label for="req_branch" class="form-label">Branch Requesting</label>
                  <input type="text" name="req_branch" id="req_branch" class="form-control" required readonly>
                </div>
                <div class="col">
                  <label for="branch_from" class="form-label">Branch Transfering</label>
                  <input type="text" name="branch_from" id="branch_from" class="form-control" required readonly>
                </div>
              </div>
            </div>
          </div>
