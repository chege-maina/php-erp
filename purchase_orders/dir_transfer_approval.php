        ...
        <div class="container" data-layout="container">
            ...
            <div class="content">
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="req_branch2" class="form-label">Branch Transfering</label>
                                    <input type="text" name="req_branch2" id="req_branch2" class="form-control" required readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    ...
                    const branch2 = document.querySelector("#req_branch2");
